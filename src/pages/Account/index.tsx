...
interface AccountProps {
  form: {
    getFieldProps: (name: keyof FormFields, options?: any) => any;
    validateFields: (callback: (error: any, value: FormFields) => void) => void;
  };
}
  ...
  return (
    <>
      ...
      <div className={s.account}>
        ...
        <Button block className={s.btn} theme="primary" onClick={onSubmit}>
          提交
        </Button>
      </div>
    </>
